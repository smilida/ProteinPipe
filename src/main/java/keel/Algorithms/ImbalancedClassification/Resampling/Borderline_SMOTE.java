...
public class Borderline_SMOTE extends Metodo {
  ...
  public void leerConfiguracion (String ficheroScript) {
    ...
    tokens = new StringTokenizer (linea, "=");
    tokens.nextToken();
    M = Integer.parseInt(tokens.nextToken().substring(0));
    
    /*Getting the type of borderline-SMOTE that should be applied: Borderline-SMOTE1 or Borderline-SMOTE2*/
    linea = lineasFichero.nextToken();
    tokens = new StringTokenizer (linea, "=");
    tokens.nextToken();
    typeBorderline = Integer.parseInt(tokens.nextToken().substring(0));
    ...
    tokens = new StringTokenizer (linea, "=");
    tokens.nextToken();
    interpolation = tokens.nextToken().substring(0);
    
    /*Getting the parameter alpha for BLX-alpha*/
    linea = lineasFichero.nextToken();
    tokens = new StringTokenizer (linea, "=");
    tokens.nextToken();
    alpha = Double.parseDouble(tokens.nextToken().substring(0));

    /*Getting the parameter mu for SBX and PBX*/
    linea = lineasFichero.nextToken();
    tokens = new StringTokenizer (linea, "=");
    tokens.nextToken();
    mu = Double.parseDouble(tokens.nextToken().substring(0));
  }
