...
import keel.Algorithms.ImbalancedClassification.Resampling.Borderline_SMOTE;

public class useBorderline_SMOTE {

    public void mainBorderline_SMOTE(){
        String configFile;
        utils scan1 = new utils();
        System.out.println("Borderline_SMOTE Configuration File");
        ...
        System.out.println("Please enter the number of neighbors for considering an instance as border:");
        String M = scan1.getInput();
        System.out.println("The type of Borderline-SMOTE 1:Borderline-SMOTE1 / 2:Borderline-SMOTE2");
        System.out.println("Please enter the type:");
        String typeBorderline = scan1.getInput();
        ...
        configFile = "Borderline_SMOTE_" + trainFile + ".txt";
        CreateImblearnConfigFile createFile = new CreateImblearnConfigFile();
        createFile.createConfigFileBorderlineSMOTE("Borderline_SMOTE", trainFile, testFile,
                trainResultFile, testResultFile, seed, neighbors, M, typeBorderline, SMOTEtype,
                balance, quantity, distance, interpolation, alpha, mu);
        Borderline_SMOTE borderline_smote = new Borderline_SMOTE(configFile);
        borderline_smote.run();
    }
