...
import keel.Algorithms.ImbalancedClassification.Resampling.SMOTE;

public class useSMOTE {

    public void mainSMOTE(){
        String configFile;
        utils scan1 = new utils();
        System.out.println("SMOTE Configuration File");
